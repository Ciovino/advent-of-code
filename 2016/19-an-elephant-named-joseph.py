...
# Problem: See ./2016/19-an-elephant-named-joseph-description.md for full details
# Author: Ciovino
...
INPUT_FILE = os.path.join('data', '2016-19.in')
...
def get_args() -> dict:
    parser = argparse.ArgumentParser(description="Solution script for 19/2016 Advent of Code.")
