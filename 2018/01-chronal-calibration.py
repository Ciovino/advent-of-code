...
# Problem: See ./2018/01-chronal-calibration-description.md for full details
# Author: Ciovino
...
INPUT_FILE = os.path.join('data', '2018-01.in')
...
def get_args() -> dict:
    parser = argparse.ArgumentParser(description="Solution script for 01/2018 Advent of Code.")
...
def parse_input(file_name) -> list[int]:
    with open(file_name, 'r') as f:
        data: list[int] = list(map(lambda s: find_numbers(s)[0], f))
    return data

# --- SOLVE ---
def solve_part1(frequencies: list[int]) -> int:
    """Solution for Part 1."""
    return sum(frequencies)

def solve_part2(frequencies: list[int]) -> int:
    """Solution for Part 2."""
    numbers: set[int] = set()
    total: int = 0
